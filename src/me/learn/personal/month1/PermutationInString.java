...
/**
 * 
 * Title : Given two strings s1 and s2, write a function to return true if s2
...
public class PermutationInString {
	...
	public static void main(String args[]) {
		...
		System.out.println(solution.checkInclusion("oab", "eidbaooo"));
		System.out.println(solution.checkInclusion("dinitrophenylhydrazine", "acetylphenylhydrazine"));
