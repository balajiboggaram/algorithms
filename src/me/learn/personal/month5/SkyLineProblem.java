...
public class SkyLineProblem {
	...
	public List<List<Integer>> getSkyline(int[][] buildings) {
        ...
        for(int building[] : buildings) {
            ...
            buildingPoints[index].x = building[0]; // start x corordinate
            ...
            buildingPoints[index + 1].x = building[1]; // end x coordinate
            buildingPoints[index + 1].isStart = false;
            buildingPoints[index + 1].height = building[2];
            index += 2;
        }
        Arrays.sort(buildingPoints); // based on x -> height -> end
        ...
        //TreeMap<Integer, Integer> queue = new TreeMap<>(); // height -> total count of buildings with this height
